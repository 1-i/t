...
Si pu\`o mostrare che ciascuno di essi \`e autostato di $2 \hat{S}_1 \cdot \hat{S}_2$ con autovalore $\hbar / 2$. Saranno dunque anche autostati di $\hat{S}^2$ con autovalore:
